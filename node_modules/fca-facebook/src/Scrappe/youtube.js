            ...
            request(url, (error, response, html) => {
                ...
                if (!error && response.statusCode === 200) {
                    ...
                    try {
                        ...
                        console.error("Failed to parse data:", ex.stack);
                        //console.log(data);
                    }
...
function parseJsonFormat(contents, json) {
    contents.forEach(sectionList => {
        try {
            if (sectionList.hasOwnProperty("itemSectionRenderer")) {
                sectionList.itemSectionRenderer.contents.forEach(content => {
                    try {
                        ...
                        console.error("Failed to parse renderer:", ex.stack);
                        //console.log(content);
                    }
                });
            ...
            console.error("Failed to read contents for section list:", ex.stack);
