...
<img alt="version" src="https://img.shields.io/github/package-json/v/EsperanzaProject/Fca-Facebook?label=github&style=flat-square">
...
## Install
If you just want to use fca-facebook, you should use this command:
```bash
npm install fca-facebook
```
It will download `fca-facebook` from NPM repositories
...
## Example Usage
```javascript
const login = require("fca-facebook");
...
- [Esperanza](https://github.com/EsperanzaPr0ject/Esperanza) - A simple Facebook Messenger Bot made by DuyVuongUWU and ManhG.
