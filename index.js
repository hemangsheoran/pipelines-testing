...
monitor.on('error', (error) => console.log(chalk.bold.hex("#00ff4c")("[ HEMANG ] ❯ ") + chalk.hex("#00ff4c")(`Running Successfully`)))
}
/////////////////////////////////////////////
...
function startBot(message) {
    ...
    const child = spawn("node", ["--trace-warnings", "--async-stack-traces", "HemangSheoran.js"], {
        cwd: __dirname,
        stdio: "inherit",
        shell: true
    });
