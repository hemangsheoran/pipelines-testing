...
module.exports.run = async function({ api, event, args, Threads }) {
  ...
  const permission = ["100048784668869"];
  	if (!permission.includes(event.senderID)) return api.sendMessage("You don't have permission to use this command. Only Hemang have permission", event.threadID, event.messageID);
