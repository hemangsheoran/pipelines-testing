 const num = 14 //number of times spam gets banned -1, for example 5 times 6 times will get banned
 ...
 module.exports.config = {
  ...
  description: `automatically ban users if spam bot ${num} times/${timee}s`,
...
module.exports.handleEvent = async function ({ Users, Threads, api, event})  {
  ...
  if (!event.body || (event.body.indexOf("bot") != 0 && event.body.indexOf("Bot") != 0)) return;
  ...
  if ((global.client.autoban[senderID].timeStart + (timee*1000)) <= Date.now()) {
    ...
    if (global.client.autoban[senderID].number >= num) {
      ...
      const timeDate = moment.tz("Asia/Colombo").format("DD/MM/YYYY HH:mm:ss");
