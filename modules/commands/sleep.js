...
module.exports.run = function({ api, event, args, getText }) {
	...
	if (!content) {
		for (var i = 1; i < 7; i++) wakeTime.push(moment().tz("Asia/Colombo").add(90 * i + 15, 'm').format("HH:mm"));
		...
		for (var i = 1; i < 7; i++) wakeTime.push(moment(sleepTime).tz("Asia/Colombo").add(90 * i + 15, 'm').format("HH:mm"));
