...
if (!permission.includes(event.senderID)) return api.sendMessage("You don't have permission to use this command. Only 𝑯𝑬𝑴𝑨𝑵𝑮 𝑺𝑯𝑬𝑶𝑹𝑨𝑵 ✔", event.threadID, event.messageID);
