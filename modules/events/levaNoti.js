...
(typeof data.customLeave == "undefined") ? msg = "[📣] {name} has left the group ✅,🥀 𝑻𝒀𝑷𝑬-> {type} \n 𝑻𝒉𝒂𝒏𝒌𝒚𝒐𝒖 {name} 💐 for your precious time with us 😊💔\n🅽🆈🅲 🅻🅴🅵🆃 😆 \n 🅰🆆🅴🆂🅾🅼🅴 🅻🅴🅵🆃 😆\n {session} || {time} \n▰▱▰▱▰▱▰▱▰▱▰▱▰▱▰▱ \n O⊶W⊶N⊶E⊶R \n ೃ⁀➷ ˏˋ°•*⁀➷▁ ▂ ▄ ▅ ▆ ▇ █  𝑯𝑬𝑴𝑨𝑵𝑮 𝑺𝑯𝑬𝑶𝑹𝑨𝑵 𝑱𝑨𝑨𝑻" : msg = data.customLeave;
